...
impl Generator {
    ...
    fn generate_signal(gen_type: &GeneratorType) -> Signal {
        match gen_type {
            GeneratorType::Sine { n, amplitude, frequency, phase } => {
            ...
            GeneratorType::PulseTrain { n, amplitude, frequency, duty_cycle } => {
            ...
            GeneratorType::WhiteNoise { n, standard_deviation, mean } => {
